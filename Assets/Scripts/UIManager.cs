...
public class UIManager : MonoBehaviour
{
    ...
    public void EnableRetryButton()
    {
        ...
        EnableAndBounce(LoseIcon, bounceAmount:-0.2f);
    }
    ...
    public void EnableNextButton()
    {
        ...
        EnableAndBounce(WinIcon, bounceAmount: -0.2f);
        EnableAndBounce((RectTransform) FinishText.transform, bounceAmount: -0.2f);
    }
    ...
    public void SetFinishText(int finishCount)
    {
        FinishText.text = $"You Saved {finishCount} People!";
    }
}
